                            ...
                            <div class="card bg-light">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <a href="{{ url('gadgethandphone/'.Crypt::encryptString($item->id))}}"><img src="{{ asset('img/company/informasi/gadget/handphone/'.$item->gambar)}}" alt="gambar gadget" class="img-fluid rounded-top"></a>
                                    </div>
                                </div>
                                <div class="row">
