                            ...
                            @forelse ($data as $item)
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <a href="{{ $item['data']->Poster}}" target="_blank"><img src="{{ $item['data']->Poster}}" alt="user-avatar" class="card-img-top img-fluid"></a> <br>
                                    ...
                                    <div class="card-footer p-0">
                                        ...
                                        @else
                                            <form action="{{ url('informasi') }}" method="post">
                                                ...
                                                <input type="hidden" name="gambar" value="{{ $item['data']->Poster }}">
                                                <input type="hidden" name="title" value="{{ $item['data']->Title }}">
                                                <input type="hidden" name="id" value="{{ $item['data']->imdbID }}">
