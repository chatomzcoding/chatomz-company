          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="#" class="btn btn-outline-primary btn-flat btn-sm" data-toggle="modal" data-target="#tambah"><i class="fas fa-plus"></i> Tambah Angoota Grup </a>
                        ...
                        @foreach ($anggota as $item)
                            ...
                            <div class="card bg-light">
                                ...
                                <div class="row">
                                    ...
                                    <p class="text-muted text-sm text-justify">kkk </p>
                                    <ul class="ml-4 mb-0 fa-ul text-muted">
                                        <li class="small"><span class="fa-li"><i class="fas fa-user"></i></span> Anggota</li>
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: + 800 - 12 12 23 52</li>
                                    </ul>
                                    </div>
                                    <div class="col-5 text-center">
                                    <img src="{{ asset('/img/chatomz/orang/'.$item->photo)}}" alt="user-avatar" class="img-fluid img-circle">
                                    </div>
                                </div>
                                </div>
