...
<link href="{{ asset('template/architectui/main.8d288f825d8dffbbe55e.css') }}" rel="stylesheet"></head>
<body>
...
<div class="app-drawer-overlay d-none animated fadeIn"></div><script type="text/javascript" src="{{ asset('template/architectui/assets/scripts/main.8d288f825d8dffbbe55e.js') }} "></script></body>
</html>
