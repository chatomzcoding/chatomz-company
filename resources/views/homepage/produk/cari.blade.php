                    ...
                    <div class="row">
                        @if (count($produk) > 0)
                            <div class="col-md-12 text-center">
                                <p><strong>Berhasil</strong>, Produk "{{ $cari }}" berhasil ditemukan.</p><hr>
                            </div>
                        @endif
                        ...
                        @empty
                            <div class="col text-center">
                                <p><strong>Maaf</strong>, Produk "{{ $cari }}" tidak ditemukan. Cari Produk lainnya</p>
