                            ...
                            <div class="blog__sidebar__recent">
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="{{ asset('/template/ogani/img/blog/sidebar/sr-1.jpg')}}" alt="">
                                    </div>
                                ...
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="{{ asset('/template/ogani/img/blog/sidebar/sr-2.jpg')}}" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
                                ...
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="{{ asset('/template/ogani/img/blog/sidebar/sr-3.jpg')}}" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="row">
                        ...
                        <div class="col-md-12 text-center">
                            <span class="text-secondary">belum ada artikel</span>
                        </div>
                        @endforelse
                        @if ($blog)
                            <div class="col-lg-12">
