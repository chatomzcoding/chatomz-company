                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card-header">
                            <a href="#" class="btn btn-outline-primary btn-flat btn-sm" data-bs-toggle="modal" data-bs-target="#tambah"><i class="bi-plus-circle-fill"></i> Keluarga</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody class="text-capitalize">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <x-aksi :id="$item->keluarga->id" link="keluarga">
                                                    <button type="button" data-bs-toggle="modal"  data-nama_keluarga="{{ $item->keluarga->nama_keluarga }}"  data-no_kk="{{ $item->keluarga->no_kk }}"  data-orang_id="{{ $item->keluarga->orang_id }}" data-tgl_pernikahan="{{ $item->keluarga->tgl_pernikahan }}" data-keterangan="{{ $item->keluarga->keterangan }}" data-status_keluarga="{{ $item->keluarga->status_keluarga }}" data-id="{{ $item->keluarga->id }}" data-bs-target="#ubah" title="" class="dropdown-item text-success" data-original-title="Edit Task">
                                                        <i class="fa fa-edit" style="width: 20px;"></i> EDIT
                                                    </button>
                                                </x-aksi>
                                            </td>
                                                <td><a href="{{ url('/keluarga/'.Crypt::encryptString($item->keluarga->id))}}">{{ $item->keluarga->nama_keluarga}}</a></td>
                                                <td>{{ date_indo($item->keluarga->tgl_pernikahan,'-')}}</td>
                                                <td><a href="https://silsilah.zelnara.com/?slug={{ $item->keluarga->slug }}" target="_blank">link</a></td>
                                                <td class="text-center">{{ $item->keluarga->status_keluarga}}</td>
                                            </tr>
                                        @empty
